...
// makeCMS3ClassFiles("/nfs-7/userdata/isuarez/STOP_ATLASBabies/data_single_muon_Run2016D_MINIAOD_PromptReco-v2.root", "t", "StopCMS3", "stoptas", "stopcms3")
...
protected: 
	...
	float    MT2_l_l_;
	TBranch *MT2_l_l_branch;
	bool     MT2_l_l_isLoaded;
	float    MT2_lb_b_;
